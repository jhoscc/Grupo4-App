        ...
        ParseFacebookUtils.logInWithReadPermissionsInBackground(this, null, new LogInCallback() {
            ...
            public void done(ParseUser user, ParseException err) {
                if (user == null) {
                    Intent intent = new Intent(MainActivity.this, TLKActivity.class);
                    startActivity(intent);
                    Log.d("TLKApp", "Uh oh. The user cancelled the Facebook login.");
                } else if (user.isNew()) {
                    Intent intent = new Intent(MainActivity.this, TLKActivity.class);
                    startActivity(intent);
                    Log.d("TLKApp", "User signed up and logged in through Facebook!");
                } else {
                    Intent intent = new Intent(MainActivity.this, TLKActivity.class);
                    startActivity(intent);
                    Log.d("TLKApp", "User logged in through Facebook!");
                }
            }
        });
    }
